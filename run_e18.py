...
def main():
    ...
    for max_steps in max_steps_list:
        run_cmd(
            [
                ...
                "python",
                "-m",
                "visualization.plot_e16_metrics",
                "--experiment",
                "18",
                "--output",
    ...
    for zone in zones:
        run_cmd(
            [
                ...
                "python",
                "-m",
                "visualization.create_timelapse",
                "--parquet",
                parquet_path,
                "--experiment",
                "18",
    ...
    run_cmd(
        [
            ...
            "python",
            "-m",
            "visualization.create_frame_strip",
            "--experiment",
            "18",
            "--out",
    ...
    run_cmd(
        [
            ...
            "python",
            "-m",
            "visualization.plot_reward_over_time",
            "--experiment",
            "18",
            "--max-steps",
            str(max_day),
    ...
    run_cmd(
        [
            ...
            "python",
            "-m",
            "visualization.plot_e18_return_energy",
            "--parquet",
            parquet_path,
            "--out",
