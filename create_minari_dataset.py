...
def main():
    ...
    parser.add_argument("--input-dir", type=str, default=f"/data/plant-rl/offline/{VERSION}/", help="Directory containing the RL filtered dataset")
    ...
    mock_env = MockEnv(df, use_continuous_actions=True)
